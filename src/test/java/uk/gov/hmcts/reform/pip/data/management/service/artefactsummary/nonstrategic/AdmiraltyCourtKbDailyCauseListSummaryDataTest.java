...
class AdmiraltyCourtKbDailyCauseListSummaryDataTest extends NonStrategicCommonArtefactSummaryTestConfig {

    @Test
    void testAdmiraltyCourtKbDailyCauseListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "admiraltyCourtKbDailyCauseList.json", ADMIRALTY_COURT_KB_DAILY_CAUSE_LIST);
