...
@ActiveProfiles("test")
class BristolAndCardiffAdministrativeCourtDailyCauseListSummaryDataTest
    extends NonStrategicCommonArtefactSummaryTestConfig {

    @Test
    void testBristolAndCardiffAdministrativeCourtDailyCauseListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "administrativeCourtDailyCauseList.json", BRISTOL_AND_CARDIFF_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST);
