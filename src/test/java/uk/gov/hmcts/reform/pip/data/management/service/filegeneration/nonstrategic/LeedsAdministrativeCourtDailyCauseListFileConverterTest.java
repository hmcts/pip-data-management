...
class LeedsAdministrativeCourtDailyCauseListFileConverterTest {
    ...
    @Test
    void testLeedsAdministrativeCourtDailyCauseListExcelConversionInEnglish() throws IOException {
        try (InputStream excelFile = getClass()
            .getResourceAsStream("/mocks/non-strategic/administrativeCourtDailyCauseList.xlsx")) {
            Map<String, String> metadata = Map.of(
                LANGUAGE_METADATA, ENGLISH,
                LIST_TYPE_METADATA, LEEDS_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST.name()
            );

            byte[] result = converter.convertToExcel(null, LEEDS_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST, metadata,
                                                     excelFile);
    ...
    @Test
    void testLeedsAdministrativeCourtDailyCauseListExcelConversionInWelsh() throws IOException {
        try (InputStream excelFile = getClass()
            .getResourceAsStream("/mocks/non-strategic/administrativeCourtDailyCauseList.xlsx")) {
            Map<String, String> metadata = Map.of(
            ...
            byte[] result = converter.convertToExcel(
                null, LEEDS_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST, metadata,
                excelFile
            );
