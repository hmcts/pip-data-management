...
@ActiveProfiles("test")
class LondonAdministrativeCourtDailyCauseListSummaryDataTest extends NonStrategicCommonArtefactSummaryTestConfig {

    @Test
    void testLondonAdministrativeCourtDailyCauseListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "londonAdministrativeCourtDailyCauseList.json", LONDON_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST);
