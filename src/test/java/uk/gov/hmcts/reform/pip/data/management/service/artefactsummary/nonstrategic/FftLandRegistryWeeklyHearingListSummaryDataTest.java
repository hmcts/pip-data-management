...
@ActiveProfiles("test")
class FftLandRegistryWeeklyHearingListSummaryDataTest {
    ...
    @Test
    void testFftLandRegistryWeeklyHearingListSummaryData() throws IOException {
        ...
        ArtefactSummaryData cstSummaryData = new ListConversionFactory()
            .getArtefactSummaryData(FFT_LR_WEEKLY_HEARING_LIST)
            .get();
