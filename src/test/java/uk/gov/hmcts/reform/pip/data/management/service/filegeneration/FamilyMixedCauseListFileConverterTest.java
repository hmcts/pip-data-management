...
class FamilyMixedCauseListFileConverterTest {
    private final FileConverter familyMixedDailyCauseListConverter = new FamilyMixedDailyCauseListFileConverter();
    ...
    private static final Map<String, String> METADATA2 = Map.of(
        "contentDate", Instant.now().toString(),
        PROVENANCE, PROVENANCE,
        "locationName", "location",
        "language", "ENGLISH",
    ...
    private static final Map<String, String> WELSH_METADATA2 = Map.of(
        "contentDate", Instant.now().toString(),
        PROVENANCE, PROVENANCE,
        "locationName", "location",
        "language", "WELSH",
    ...
    @Test
    void testCivilAndFamilyCauseListPDFTemplate() throws IOException {
        ...
        JsonNode inputJson = getInputJson("civilAndFamilyDailyCauseList.json");
        String outputHtml = familyMixedDailyCauseListConverter.convert(inputJson, METADATA, language);
    ...
    @Test
    void testCivilAndFamilyCauseListPDFTemplateWelsh() throws IOException {
        Map<String, Object> language;
        try (InputStream languageFile = Thread.currentThread()
        ...
        JsonNode inputJson = getInputJson("civilAndFamilyDailyCauseList.json");
        String outputHtml = familyMixedDailyCauseListConverter.convert(inputJson, WELSH_METADATA, language);
        Document document = Jsoup.parse(outputHtml);
        assertThat(outputHtml).as("No html found").isNotEmpty();
    ...
    void testFamilyCauseListPDFTemplate() throws IOException {
        ...
        JsonNode inputJson = getInputJson("familyDailyCauseList.json");
        String outputHtml = familyMixedDailyCauseListConverter.convert(inputJson, METADATA2, language);
    ...
    void testFamilyCauseListPDFTemplateWelsh() throws IOException {
        ...
        JsonNode inputJson = getInputJson("familyDailyCauseList.json");
        String outputHtml = familyMixedDailyCauseListConverter.convert(inputJson, WELSH_METADATA2, language);
    ...
    @Test
    void testCivilAndFamilyPDFTableContents() throws IOException {
        Map<String, Object> language;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader().getResourceAsStream("templates/languages/en/civilAndFamilyDailyCauseList.json")) {
            language = OBJECT_MAPPER.readValue(
        ...
        JsonNode inputJson = getInputJson("civilAndFamilyDailyCauseList.json");
        String result = familyMixedDailyCauseListConverter.convert(inputJson, METADATA, language);
    ...
    @Test
    void testFamilyTablePDFContents() throws IOException {
        Map<String, Object> language;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader().getResourceAsStream("templates/languages/en/familyDailyCauseList.json")) {
            language = OBJECT_MAPPER.readValue(
        ...
        JsonNode inputJson = getInputJson("familyDailyCauseList.json");
        String result = familyMixedDailyCauseListConverter.convert(inputJson, METADATA2, language);
    ...
    @Test
    void testCivilAndFamilyExcelTableHeaderEnglish() throws IOException {
        ...
        assertEquals("Respondent column is different", "Respondent",
                     headingRow.getCell(10).getStringCellValue());
        assertEquals("Reporting Restrictions column is different", "Reporting Restriction: ",
                     headingRow.getCell(11).getStringCellValue());
    }

    @Test
    void testExcelCivilAndFamilyTableHeaderWelsh() throws IOException {
        StringWriter writer = new StringWriter();
        IOUtils.copy(Files.newInputStream(Paths.get("src/test/resources/mocks/",
                                                    "civilAndFamilyDailyCauseList.json")), writer,
                     Charset.defaultCharset()
    ...
    @Test
    void testCivilAndFamilyExcelTableRows() throws IOException {
        StringWriter writer = new StringWriter();
        IOUtils.copy(
        ...
        assertEquals("Court House value is different", "This is the site name",
                     dataRow.getCell(0).getStringCellValue());
        assertEquals("Court Room value is different", "This is the court room name, "
                         + "Before: Judge KnownAs Presiding, Judge KnownAs 2",
    ...
    @Test
    void testFamilyExcelTableHeaderEnglish() throws IOException {
        StringWriter writer = new StringWriter();
        IOUtils.copy(Files.newInputStream(Paths.get("src/test/resources/mocks/",
    ...
    @Test
    void testFamilyExcelTableHeaderWelsh() throws IOException {
        StringWriter writer = new StringWriter();
        IOUtils.copy(Files.newInputStream(Paths.get("src/test/resources/mocks/",
                                                    "familyDailyCauseList.json")), writer,
                     Charset.defaultCharset()
    ...
    @Test
    void testFamilyExcelTableRows() throws IOException {
        StringWriter writer = new StringWriter();
        IOUtils.copy(
            Files.newInputStream(Paths.get(
                "src/test/resources/mocks/",
        ...
        assertEquals("Court House value is different", "This is the site name",
                     dataRow.getCell(0).getStringCellValue());
        assertEquals("Court Room value is different", "This is the court room name, "
                         + "Before: Judge KnownAs Presiding, Judge KnownAs",
                     dataRow.getCell(1).getStringCellValue());
        assertEquals("Time value is different", "10:30am",
                     dataRow.getCell(2).getStringCellValue());
        assertEquals("Case ref value is different", "12341234",
    ...
    private JsonNode getInputJson(String list) throws IOException {
        StringWriter writer = new StringWriter();
        IOUtils.copy(Files.newInputStream(Paths.get("src/test/resources/mocks/",
                                                    list)), writer,
                     Charset.defaultCharset()
