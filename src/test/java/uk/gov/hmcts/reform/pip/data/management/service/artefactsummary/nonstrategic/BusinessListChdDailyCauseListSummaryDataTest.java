...
class BusinessListChdDailyCauseListSummaryDataTest extends NonStrategicCommonArtefactSummaryTestConfig {

    @Test
    void testBusinessListChdDailyCauseListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "businessListChdDailyCauseList.json", BUSINESS_LIST_CHD_DAILY_CAUSE_LIST);
