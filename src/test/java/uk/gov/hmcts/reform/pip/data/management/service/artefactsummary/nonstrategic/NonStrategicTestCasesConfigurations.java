    ...
    public static Stream<ArtefactSummaryTestInput> provideTestCases() {
        return Stream.of(
            ...
            new ArtefactSummaryTestInput(
                ...
                2,
                9,
                List.of(DATE_FIELD, HEARING_TIME_FIELD_2, VENUE_FIELD, CASE_TYPE_FIELD, CASE_REFERENCE_NUMBER_FIELD, JUDGES_FIELD, MEMBERS_FIELD, HEARING_METHOD_FIELD, ADDITIONAL_INFORMATION_FIELD),
                List.of(DATE_TEXT, TIME_TEXT_4, VENUE_TEXT_2, CASE_TYPE_TEXT, CASE_REFERENCE_NUMBER_TEXT_1, JUDGES_TEXT, MEMBERS_TEXT, HEARING_METHOD_TEXT, ADDITIONAL_INFORMATION_TEXT)
            ),
            new ArtefactSummaryTestInput(
