...
class RevenueListChdDailyCauseListSummaryDataTest extends NonStrategicCommonArtefactSummaryTestConfig {

    @Test
    void testRevenueListChdDailyCauseListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "revenueListChdDailyCauseList.json", REVENUE_LIST_CHD_DAILY_CAUSE_LIST);
