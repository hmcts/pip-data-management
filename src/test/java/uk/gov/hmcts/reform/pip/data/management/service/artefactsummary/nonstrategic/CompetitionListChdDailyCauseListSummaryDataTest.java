...
class CompetitionListChdDailyCauseListSummaryDataTest extends NonStrategicCommonArtefactSummaryTestConfig {

    @Test
    void testCompetitionListChdDailyCauseListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "competitionListChdDailyCauseList.json", COMPETITION_LIST_CHD_DAILY_CAUSE_LIST);
