...
class AzureArtefactBlobServiceTest {
    ...
    void testCreationOfNewBlob() {
        ...
        String blobUrl = azureArtefactBlobService.createPayload(BLOB_NAME, PAYLOAD);
    ...
    void testGetBlobData() {
        ...
        String blobData = azureArtefactBlobService.getBlobData(BLOB_NAME);
    ...
    void testGetBlobFile() {
        ...
        Resource blobFile = azureArtefactBlobService.getBlobFile(BLOB_NAME);
    ...
    void testCreationOfNewBlobViaFile() {
        ...
        String blobUrl = azureArtefactBlobService.uploadFlatFile(BLOB_NAME, FILE);
    ...
    void testDeleteBlob() {
        assertEquals(String.format("Blob: %s successfully deleted.", BLOB_NAME),
                     azureArtefactBlobService.deleteBlob(BLOB_NAME),
                     MESSAGES_MATCH);
    }
}
