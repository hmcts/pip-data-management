...
class InsolvencyAndCompaniesCourtChdDailyCauseListSummaryDataTest {
    ...
    @Test
    void testInsolvencyAndCompaniesCourtChdDailyCauseListSummaryData() throws IOException {
        ...
        ArtefactSummaryData cstSummaryData = new ListConversionFactory()
            .getArtefactSummaryData(INSOLVENCY_AND_COMPANIES_COURT_CHD_DAILY_CAUSE_LIST)
            .get();
