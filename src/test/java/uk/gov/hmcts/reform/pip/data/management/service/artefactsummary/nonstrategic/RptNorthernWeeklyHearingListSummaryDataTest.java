...
@ActiveProfiles("test")
class RptNorthernWeeklyHearingListSummaryDataTest {
    ...
    @Test
    void testRptNorthernWeeklyHearingListSummaryData() throws IOException {
        ...
        ArtefactSummaryData cstSummaryData = new ListConversionFactory()
            .getArtefactSummaryData(RPT_NORTHERN_WEEKLY_HEARING_LIST)
            .get();
