...
class IntellectualPropertyListChdDailyCauseListFileConverterTest {
    ...
    void setup() throws IOException {
        try (InputStream inputStream = getClass()
            .getResourceAsStream("/mocks/non-strategic/intellectualPropertyListChdDailyCauseList.json")) {
    ...
    @Test
    void testIntellectualPropertyListChdDailyCauseListFileConversionInEnglish() throws IOException {
    ...
    @Test
    void testIntellectualPropertyListChdDailyCauseListFileConversionInWelsh() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
    ...
    @Test
    void testIntellectualPropertyListChdDailyCauseListTableContents() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
            .getResourceAsStream("templates/languages/en/non-strategic/"
