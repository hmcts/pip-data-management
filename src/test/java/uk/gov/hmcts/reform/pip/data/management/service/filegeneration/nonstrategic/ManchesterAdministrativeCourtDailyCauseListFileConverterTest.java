...
class ManchesterAdministrativeCourtDailyCauseListFileConverterTest {
    ...
    @Test
    void testManchesterAdministrativeCourtDailyCauseListTableContents() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
            .getResourceAsStream("templates/languages/en/non-strategic/"
    ...
    @Test
    void testManchesterAdministrativeCourtDailyCauseListExcelConversionInEnglish() throws IOException {
        try (InputStream excelFile = getClass()
            .getResourceAsStream("/mocks/non-strategic/administrativeCourtDailyCauseList.xlsx")) {
            Map<String, String> metadata = Map.of(
                LANGUAGE_METADATA, ENGLISH,
                LIST_TYPE_METADATA, MANCHESTER_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST.name()
            );

            byte[] result = converter.convertToExcel(null, MANCHESTER_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST, metadata,
                                                     excelFile);
    ...
    @Test
    void testManchesterAdministrativeCourtDailyCauseListExcelConversionInWelsh() throws IOException {
        try (InputStream excelFile = getClass()
            .getResourceAsStream("/mocks/non-strategic/administrativeCourtDailyCauseList.xlsx")) {
            Map<String, String> metadata = Map.of(
            ...
            byte[] result = converter.convertToExcel(
                null, MANCHESTER_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST, metadata,
                excelFile
            );
