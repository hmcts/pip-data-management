...
class RptLondonWeeklyHearingListFileConverterTest {
    ...
    private static final String LIST_NAME = RPT_LONDON_WEEKLY_HEARING_LIST.name();
    private static final String LIST_ENGLISH_NAME = "Residential Property Tribunal: London region Weekly Hearing List";
    ...
    private static final String LIST_WELSH_NAME = "Tribiwnlys Eiddo Preswyl: Rhestr o "
        + "Wrandawiadau Wythnosol rhanbarth Llundain";
    ...
    @Test
    void testRptLondonWeeklyHearingListFileConversionInEnglish() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
            .getResourceAsStream("templates/languages/en/non-strategic/rptLondonWeeklyHearingList.json")) {
    ...
    @Test
    void testRptLondonWeeklyHearingListFileConversionInWelsh() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
            .getResourceAsStream("templates/languages/cy/non-strategic/rptLondonWeeklyHearingList.json")) {
            languageResource = new ObjectMapper().readValue(
                Objects.requireNonNull(languageFile).readAllBytes(), new TypeReference<>() {
                });
        }
