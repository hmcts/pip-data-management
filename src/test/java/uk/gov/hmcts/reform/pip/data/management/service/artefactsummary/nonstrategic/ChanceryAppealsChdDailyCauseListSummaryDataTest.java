...
class ChanceryAppealsChdDailyCauseListSummaryDataTest extends NonStrategicCommonArtefactSummaryTestConfig {

    @Test
    void testChanceryAppealsChdDailyCauseListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "chanceryAppealsChdDailyCauseList.json", CHANCERY_APPEALS_CHD_DAILY_CAUSE_LIST);
