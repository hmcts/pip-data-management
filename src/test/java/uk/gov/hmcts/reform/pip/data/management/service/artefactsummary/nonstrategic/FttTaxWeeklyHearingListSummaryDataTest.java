...
@ActiveProfiles("test")
class FttTaxWeeklyHearingListSummaryDataTest extends NonStrategicCommonArtefactSummaryTestConfig {

    @Test
    void testFttTaxWeeklyHearingListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "fttTaxWeeklyHearingList.json", FTT_TAX_WEEKLY_HEARING_LIST);
