...
@ActiveProfiles("test")
class FamilyDivisionHighCourtDailyCauseListSummaryDataTest extends NonStrategicCommonArtefactSummaryTestConfig {

    @Test
    void testFamilyDivisionHighCourtDailyCauseListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "familyDivisionHighCourtDailyCauseList.json", FAMILY_DIVISION_HIGH_COURT_DAILY_CAUSE_LIST);
