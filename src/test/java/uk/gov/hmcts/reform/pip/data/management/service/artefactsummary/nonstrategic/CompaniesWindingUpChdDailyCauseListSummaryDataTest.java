...
class CompaniesWindingUpChdDailyCauseListSummaryDataTest extends NonStrategicCommonArtefactSummaryTestConfig {

    @Test
    void testCompaniesWindingUpChdDailyCauseListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "companiesWindingUpChdDailyCauseList.json", COMPANIES_WINDING_UP_CHD_DAILY_CAUSE_LIST);
