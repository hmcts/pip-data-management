...
class BirminghamAdministrativeCourtDailyCauseListFileConverterTest {
    ...
    @Test
    void testBirminghamAdministrativeCourtDailyCauseListFileConversionInEnglish() throws IOException {
        ...
        Map<String, String> metadata = Map.of(CONTENT_DATE_METADATA, CONTENT_DATE,
                                              ...
                                              BIRMINGHAM_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST.name(),
        ...
        softly.assertThat(document.title())
            .as(TITLE_MESSAGE)
            .isEqualTo("Birmingham Administrative Court Daily Cause List");
    ...
    @Test
    void testBirminghamAdministrativeCourtDailyCauseListFileConversionInWelsh() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
        ...
        softly.assertThat(document.title())
            .as(TITLE_MESSAGE)
            .isEqualTo("Rhestr Achosion Dyddiol Llys Gweinyddol Birmingham");
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_2).text())
            ...
            .contains("Bydd dyfarniadau a draddodir gan y barnwr o bell yn cael eu "
                          ...
                          + "dyfarniad ar ffurf derfynol fel y'i traddodwyd ar ôl yr amser hwnnw, "
                          + "ar gais drwy e-bost.");
    ...
    @Test
    void testBirminghamAdministrativeCourtDailyCauseListTableContents() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
            .getResourceAsStream("templates/languages/en/non-strategic/"
    ...
    @Test
    void testBirminghamAdministrativeCourtDailyCauseListExcelConversionInEnglish() throws IOException {
        try (InputStream excelFile = getClass()
            .getResourceAsStream("/mocks/non-strategic/administrativeCourtDailyCauseList.xlsx")) {
            Map<String, String> metadata = Map.of(
                LANGUAGE_METADATA, ENGLISH,
                LIST_TYPE_METADATA, BIRMINGHAM_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST.name()
            );

            byte[] result = converter.convertToExcel(null, BIRMINGHAM_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST, metadata,
                                                     excelFile);
    ...
    @Test
    void testBirminghamAdministrativeCourtDailyCauseListExcelConversionInWelsh() throws IOException {
        try (InputStream excelFile = getClass()
            .getResourceAsStream("/mocks/non-strategic/administrativeCourtDailyCauseList.xlsx")) {
            Map<String, String> metadata = Map.of(
            ...
            byte[] result = converter.convertToExcel(
                null, BIRMINGHAM_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST, metadata,
                excelFile
            );
