...
class LondonCircuitCommercialCourtKbDailyCauseListFileConverterTest {
    ...
    void setup() throws IOException {
        try (InputStream inputStream = getClass()
            .getResourceAsStream("/mocks/non-strategic/londonCircuitCommercialCourtKbDailyCauseList.json")) {
    ...
    @Test
    void testLondonCircuitCommercialCourtKbDailyCauseListFileConversionInEnglish() throws IOException {
        ...
        Map<String, String> metadata = Map.of(CONTENT_DATE_METADATA, CONTENT_DATE,
                                              ...
                                              LONDON_CIRCUIT_COMMERCIAL_COURT_KB_DAILY_CAUSE_LIST.name(),
        ...
        softly.assertThat(document.title())
            .as(TITLE_MESSAGE)
            .isEqualTo("London Circuit Commercial Court (King’s Bench Division) Daily Cause List");
        ...
        softly.assertThat(document.getElementsByClass(SUMMARY_TEXT_CLASS).get(0).text())
            .as(IMPORTANT_INFORMATION_MESSAGE)
            .contains("The hearing will be available to representatives of the media upon request. It will be "
                          + "organised and conducted using MS Teams (unless otherwise stated). Any media "
                          ...
                          + "appropriate link for access. Please contact comct.listing@justice.gov.uk.");
    ...
    void testLondonCircuitCommercialCourtKbDailyCauseListFileConversionInWelsh() throws IOException {
        ...
        softly.assertThat(document.title())
            .as(TITLE_MESSAGE)
            .isEqualTo("Rhestr Achosion Dyddiol Llys Masnachol Cylchdaith Llundain (Adran Mainc y Brenin)");
        ...
        softly.assertThat(document.getElementsByClass(SUMMARY_TEXT_CLASS).get(0).text())
            ...
            .contains("Bydd y gwrandawiad ar gael i gynrychiolwyr y cyfryngau ar gais. Bydd yn cael ei drefnu a'i "
                          + "gynnal gan ddefnyddio MS Teams (oni nodir yn wahanol). Bydd angen i unrhyw gynrychiolydd "
                          + "y cyfryngau (neu unrhyw aelod arall o'r cyhoedd) sy'n dymuno gweld y gwrandawiad wneud "
                          + "hynny dros y rhyngrwyd a darparu cyfeiriad e-bost i gael dolen briodol ar gyfer cael "
                          + "mynediad. Cysylltwch â comct.listing@justice.gov.uk.");
    ...
    @Test
    void testLondonCircuitCommercialCourtKbDailyCauseListTableContents() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
            .getResourceAsStream("templates/languages/en/non-strategic/"
