...
@ActiveProfiles("test")
class BusinessAndPropertyDivisionRollsBuildingDailyCauseListSummaryDataTest {
    ...
    @Test
    void testBusinessAndPropertyDivisionRollsBuildingDailyCauseListTemplate() throws IOException {
        ...
        Map<String, List<Map<String, String>>> output = new ListConversionFactory()
            .getArtefactSummaryData(BUSINESS_AND_PROPERTY_DIVISION_ROLLS_BUILDING_DAILY_CAUSE_LIST).get()
            .get(payload);
        ...
        List<Map<String, String>> summaryCases = output.get("Appeal list");
