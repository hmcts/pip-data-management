...
@ActiveProfiles("test")
class LeedsAdministrativeCourtDailyCauseListSummaryDataTest extends NonStrategicCommonArtefactSummaryTestConfig {

    @Test
    void testLeedsAdministrativeCourtDailyCauseListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "administrativeCourtDailyCauseList.json", LEEDS_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST);
