...
@ActiveProfiles("test")
class BirminghamAdministrativeCourtDailyCauseListSummaryDataTest extends NonStrategicCommonArtefactSummaryTestConfig {

    @Test
    void testBirminghamAdministrativeCourtDailyCauseListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "administrativeCourtDailyCauseList.json", BIRMINGHAM_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST);
