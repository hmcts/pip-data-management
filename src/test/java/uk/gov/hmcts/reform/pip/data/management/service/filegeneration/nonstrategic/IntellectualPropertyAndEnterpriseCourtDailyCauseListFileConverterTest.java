...
class IntellectualPropertyAndEnterpriseCourtDailyCauseListFileConverterTest {
    ...
    void setup() throws IOException {
        try (InputStream inputStream = getClass()
            .getResourceAsStream("/mocks/non-strategic/intellectualPropertyAndEnterpriseCourtDailyCauseList.json")) {
    ...
    @Test
    void testIntellectualPropertyAndEnterpriseCourtDailyCauseListFileConversionInEnglish() throws IOException {
        ...
        softly.assertThat(document.title())
            .as(TITLE_MESSAGE)
            .isEqualTo("Intellectual Property and Enterprise Court Daily Cause List");
    ...
    @Test
    void testIntellectualPropertyAndEnterpriseCourtDailyCauseListFileConversionInWelsh() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
        ...
        softly.assertThat(document.title())
            .as(TITLE_MESSAGE)
            .isEqualTo("Rhestr Achosion Dyddiol Llys Mentrau Eiddo Deallusol");
