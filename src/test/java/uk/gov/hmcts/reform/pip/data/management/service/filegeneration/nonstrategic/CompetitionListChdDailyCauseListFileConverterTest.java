...
class CompetitionListChdDailyCauseListFileConverterTest {
    ...
    void setup() throws IOException {
        try (InputStream inputStream = getClass()
            .getResourceAsStream("/mocks/non-strategic/competitionListChdDailyCauseList.json")) {
    ...
    @Test
    void testCompetitionListChdDailyCauseListFileConversionInEnglish() throws IOException {
        ...
        Map<String, String> metadata = Map.of(CONTENT_DATE_METADATA, CONTENT_DATE,
                                              ...
                                              COMPETITION_LIST_CHD_DAILY_CAUSE_LIST.name(),
        ...
        softly.assertThat(document.title())
            .as(TITLE_MESSAGE)
            .isEqualTo("Competition List (Chancery Division) Daily Cause List");
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_1).text())
            ...
            .contains("If a representative of the media or member of the public "
                          ...
                          + "listing office chanceryjudgeslisting@justice.gov.uk who "
                          + "will put them in touch with the relevant person.");
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_2).text())
            .as(IMPORTANT_INFORMATION_MESSAGE)
            .contains("If a representative of the media or member of the public "
                          + "wishes to attend the remote hearing they should "
                          + "contact chancery.mastersappointments@justice.gov.uk "
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_3).text())
            ...
            .contains("Remote hand-down: This judgment will be handed down remotely "
                          ...
                          + "The National Archives website shortly thereafter. Members of "
                          + "the media can obtain a copy on request by email to the Judicial "
                          + "Office press.enquiries@judiciary.uk");
    ...
    @Test
    void testCompetitionListChdDailyCauseListFileConversionInWelsh() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
        ...
        softly.assertThat(document.title())
            .as(TITLE_MESSAGE)
            .isEqualTo("Rhestr Achosion Dyddiol Cystadleuaeth (Adran Siawnsri)");
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_1).text())
            ...
            .contains("Os yw cynrychiolydd o'r cyfryngau neu aelod o'r cyhoedd yn "
                          ...
                          + "swyddfa restru yn chanceryjudgeslisting@justice.gov.uk "
                          + "a fydd yn eu rhoi mewn cysylltiad â'r unigolyn perthnasol.");
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_2).text())
            .as(IMPORTANT_INFORMATION_MESSAGE)
            .contains("Os yw cynrychiolydd o'r cyfryngau neu aelod o'r cyhoedd yn "
                          + "dymuno mynychu'r gwrandawiad o bell, dylent gysylltu â "
                          + "chancery.mastersappointments@justice.gov.uk a fydd yn eu "
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_3).text())
            ...
            .contains("Traddodi o Bell: Bydd y dyfarniad hwn yn cael ei "
                          ...
                          + "Dylai copi o'r dyfarniad ar ffurf derfynol fel y'i rhoddwyd "
                          + "fod ar gael ar wefan yr Archifau Cenedlaethol yn fuan wedyn. "
                          + "Gall aelodau'r cyfryngau gael copi ar gais trwy e-bost i'r "
    ...
    @Test
    void testCompetitionListChdDailyCauseListTableContents() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
            .getResourceAsStream("templates/languages/en/non-strategic/"
