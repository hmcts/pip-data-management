...
class RptNorthernWeeklyHearingListFileConverterTest {
    ...
    private static final String LIST_NAME = RPT_NORTHERN_WEEKLY_HEARING_LIST.name();
    private static final String LIST_ENGLISH_NAME = "Residential Property Tribunal: "
        + "Northern region Weekly Hearing List";
    ...
    private static final String LIST_WELSH_NAME = "Tribiwnlys Eiddo Preswyl: Rhestr o Wrandawiadau "
        + "Wythnosol rhanbarth Gogledd Lloegr";
    ...
    @Test
    void testRptNorthernWeeklyHearingListFileConversionInEnglish() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
            .getResourceAsStream("templates/languages/en/non-strategic/rptNorthernWeeklyHearingList.json")) {
    ...
    @Test
    void testRptNorthernWeeklyHearingListFileConversionInWelsh() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
            .getResourceAsStream("templates/languages/cy/non-strategic/rptNorthernWeeklyHearingList.json")) {
            languageResource = new ObjectMapper().readValue(
                Objects.requireNonNull(languageFile).readAllBytes(), new TypeReference<>() {
                });
        }
