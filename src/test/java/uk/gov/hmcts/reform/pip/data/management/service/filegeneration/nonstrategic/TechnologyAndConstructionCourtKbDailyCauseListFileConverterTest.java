...
class TechnologyAndConstructionCourtKbDailyCauseListFileConverterTest {
    ...
    void setup() throws IOException {
        try (InputStream inputStream = getClass()
            .getResourceAsStream("/mocks/non-strategic/technologyAndConstructionCourtKbDailyCauseList.json")) {
    ...
    @Test
    void testTechnologyAndConstructionCourtKbDailyCauseListFileConversionInEnglish() throws IOException {
    ...
    @Test
    void testTechnologyAndConstructionCourtKbDailyCauseListFileConversionInWelsh() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
    ...
    @Test
    void testTechnologyAndConstructionCourtKbDailyCauseListTableContents() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
            .getResourceAsStream("templates/languages/en/non-strategic/"
