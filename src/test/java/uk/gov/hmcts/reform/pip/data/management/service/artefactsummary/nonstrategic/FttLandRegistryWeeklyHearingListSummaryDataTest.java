...
@ActiveProfiles("test")
class FttLandRegistryWeeklyHearingListSummaryDataTest extends NonStrategicCommonArtefactSummaryTestConfig {
    ...
    void testFttLandRegistryWeeklyHearingListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "fttLandRegistryTribunalWeeklyHearingList.json", FTT_LR_WEEKLY_HEARING_LIST);
