...
class InsolvencyAndCompaniesCourtChdDailyCauseListFileConverterTest {
    ...
    void setup() throws IOException {
        try (InputStream inputStream = getClass()
            .getResourceAsStream("/mocks/non-strategic/insolvencyAndCompaniesCourtChdDailyCauseList.json")) {
    ...
    @Test
    void testInsolvencyAndCompaniesCourtChdDailyCauseListFileConversionInEnglish() throws IOException {
        ...
        Map<String, String> metadata = Map.of(CONTENT_DATE_METADATA, CONTENT_DATE,
                                              ...
                                              INSOLVENCY_AND_COMPANIES_COURT_CHD_DAILY_CAUSE_LIST.name(),
        ...
        softly.assertThat(document.title())
            .as(TITLE_MESSAGE)
            .isEqualTo("Insolvency & Companies Court (Chancery Division) Daily Cause List");
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_1).text())
            .as(IMPORTANT_INFORMATION_MESSAGE)
            .contains("If a representative of the media or member of the public wishes to "
                          + "attend the hearing they should contact the listing office "
                          + "chanceryjudgeslisting@justice.gov.uk who will put them in "
                          + "touch with the relevant person.");

        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_HEADING_2).text())
            .as(BODY_MESSAGE)
            .isEqualTo("Remote hearings before an Insolvency and Companies Court Judge");

        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_2).text())
            .as(IMPORTANT_INFORMATION_MESSAGE)
            .contains("If a representative of the media or member of the public wishes to "
                          + "attend the hearing, they should contact the ICC judges’ clerks at "
                          + "rolls.icl.hearings1@justice.gov.uk who will put them in touch with "
                          + "the relevant person.");
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_3).text())
            ...
            .contains("Remote hand-down: This judgment will be handed down remotely by "
                          + "circulation to the parties or their representatives by "
                          + "email and release to The National Archives. A copy of the "
                          + "judgment in final form as handed down should be available on "
                          + "The National Archives website shortly thereafter. Members of the "
                          + "media can obtain a copy on request by email to the Judicial Office "
    ...
    @Test
    void testInsolvencyAndCompaniesCourtChdDailyCauseListFileConversionInWelsh() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
        ...
        softly.assertThat(document.title())
            .as(TITLE_MESSAGE)
            .isEqualTo("Rhestr Achosion Dyddiol Llys Cwmnïau ac achosion Ansolfedd (Adran Siawnsri)");
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_1).text())
            ...
            .contains("Os yw cynrychiolydd o'r cyfryngau neu aelod o'r cyhoedd yn "
                          + "dymuno mynychu'r gwrandawiad, dylent gysylltu â'r swyddfa restru "
                          + "yn chanceryjudgeslisting@justice.gov.uk a fydd yn eu rhoi mewn "
                          + "cysylltiad â'r unigolyn perthnasol.");

        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_HEADING_2).text())
            .as(BODY_MESSAGE)
            .isEqualTo("Gwrandawiadau o bell gerbron Barnwr y Llys Cwmnïau ac achosion Ansolfedd");

        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_2).text())
            .as(IMPORTANT_INFORMATION_MESSAGE)
            .contains("Os yw cynrychiolydd o'r cyfryngau neu aelod o'r cyhoedd yn "
                          + "dymuno mynychu'r gwrandawiad, dylent gysylltu â'r Clerc y "
                          + "Barnwr yn rolls.icl.hearings1@justice.gov.uk a fydd yn eu "
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_3).text())
            .as(IMPORTANT_INFORMATION_MESSAGE)
            .contains("Traddodi o Bell: Bydd y dyfarniad hwn yn cael ei draddodi o "
                          + "bell trwy gylchrediad i'r partïon neu eu cynrychiolwyr trwy e-bost "
                          + "a'i ryddhau i'r Archifau Cenedlaethol. Dylai copi o'r dyfarniad ar "
                          + "ffurf derfynol fel y'i rhoddwyd fod ar gael ar wefan yr Archifau "
                          + "Cenedlaethol yn fuan wedyn. Gall aelodau'r cyfryngau gael copi ar "
                          + "gais trwy e-bost i'r Swyddfa Farnwrol press.enquiries@judiciary.uk");
    ...
    @Test
    void testInsolvencyAndCompaniesCourtChdDailyCauseListTableContents() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
            .getResourceAsStream("templates/languages/en/non-strategic/"
