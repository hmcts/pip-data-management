...
@ActiveProfiles("test")
class KingsBenchMastersDailyCauseListSummaryDataTest extends NonStrategicCommonArtefactSummaryTestConfig {

    @Test
    void testKingsBenchMastersDailyCauseListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "kingsBenchMastersDailyCauseList.json", KINGS_BENCH_MASTERS_DAILY_CAUSE_LIST);
