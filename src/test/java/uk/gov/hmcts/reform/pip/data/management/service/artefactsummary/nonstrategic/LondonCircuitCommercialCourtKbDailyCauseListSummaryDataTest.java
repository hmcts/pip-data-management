...
class LondonCircuitCommercialCourtKbDailyCauseListSummaryDataTest {
    ...
    @Test
    void testLondonCircuitCommercialCourtKbDailyCauseListSummaryData() throws IOException {
        ...
        ArtefactSummaryData cstSummaryData = new ListConversionFactory()
            .getArtefactSummaryData(LONDON_CIRCUIT_COMMERCIAL_COURT_KB_DAILY_CAUSE_LIST)
            .get();
