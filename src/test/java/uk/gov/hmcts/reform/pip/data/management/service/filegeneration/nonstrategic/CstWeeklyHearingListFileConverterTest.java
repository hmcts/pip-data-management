...
class CstWeeklyHearingListFileConverterTest {
    ...
    @Test
    void testCareStandardsListExcelConversionInEnglish() throws IOException {
        try (InputStream excelFile = getClass().getResourceAsStream("/mocks/non-strategic/cstWeeklyHearingList.xlsx")) {
            Map<String, String> metadata = Map.of(
                LANGUAGE_METADATA, ENGLISH,
                LIST_TYPE_METADATA, CST_WEEKLY_HEARING_LIST.name()
            );

            byte[] result = converter.convertToExcel(null, CST_WEEKLY_HEARING_LIST, metadata, excelFile);
    ...
    @Test
    void testCareStandardsListExcelConversionInWelsh() throws IOException {
        try (InputStream excelFile = getClass().getResourceAsStream("/mocks/non-strategic/cstWeeklyHearingList.xlsx")) {
            Map<String, String> metadata = Map.of(
                LANGUAGE_METADATA, WELSH,
                LIST_TYPE_METADATA, CST_WEEKLY_HEARING_LIST.name()
