...
class PropertyTrustsProbateListChdDailyCauseListSummaryDataTest {
    ...
    @Test
    void testPropertyTrustsProbateListChdDailyCauseListSummaryData() throws IOException {
        ...
        ArtefactSummaryData summaryData = new ListConversionFactory()
            .getArtefactSummaryData(PROPERTY_TRUSTS_PROBATE_LIST_CHD_DAILY_CAUSE_LIST)
            .get();
