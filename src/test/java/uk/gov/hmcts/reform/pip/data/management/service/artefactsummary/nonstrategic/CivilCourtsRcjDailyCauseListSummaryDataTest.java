...
@ActiveProfiles("test")
class CivilCourtsRcjDailyCauseListSummaryDataTest extends NonStrategicCommonArtefactSummaryTestConfig {
    ...
    void testCivilCourtsRcjDailyCauseListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "civilCourtsRcjDailyCauseList.json", CIVIL_COURTS_RCJ_DAILY_CAUSE_LIST);
