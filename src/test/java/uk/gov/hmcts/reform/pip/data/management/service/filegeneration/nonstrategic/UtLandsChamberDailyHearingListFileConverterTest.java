...
class UtLandsChamberDailyHearingListFileConverterTest {
    ...
    @Test
    void testLandsChamberDailyHearingListTableContents() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
            .getResourceAsStream("templates/languages/en/non-strategic/utLcDailyHearingList.json")) {
    ...
    @Test
    void testLandsChamberDailyHearingListExcelConversionInEnglish() throws IOException {
        try (InputStream excelFile = getClass()
            .getResourceAsStream("/mocks/non-strategic/utLandsChamberDailyHearingList.xlsx")) {
            Map<String, String> metadata = Map.of(
                LANGUAGE_METADATA, ENGLISH,
                LIST_TYPE_METADATA, UT_LC_DAILY_HEARING_LIST.name()
            );

            byte[] result = converter.convertToExcel(null, UT_LC_DAILY_HEARING_LIST, metadata,
                                                     excelFile);
    ...
    @Test
    void testLandsChamberChamberDailyHearingListExcelConversionInWelsh() throws IOException {
        try (InputStream excelFile = getClass()
            .getResourceAsStream("/mocks/non-strategic/utLandsChamberDailyHearingList.xlsx")) {
            Map<String, String> metadata = Map.of(
                LANGUAGE_METADATA, WELSH,
