...
class AdmiraltyCourtKbDailyCauseListFileConverterTest {
    ...
    void setup() throws IOException {
        try (InputStream inputStream = getClass()
            .getResourceAsStream("/mocks/non-strategic/admiraltyCourtKbDailyCauseList.json")) {
    ...
    @Test
    void testAdmiraltyCourtKbDailyCauseListFileConversionInEnglish() throws IOException {
        ...
        Map<String, String> metadata = Map.of(CONTENT_DATE_METADATA, CONTENT_DATE,
                                              ...
                                              ADMIRALTY_COURT_KB_DAILY_CAUSE_LIST.name(),
        ...
        softly.assertThat(document.title())
            .as(TITLE_MESSAGE)
            .isEqualTo("Admiralty Court (King’s Bench Division) Daily Cause List");
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_1).text())
            .as(IMPORTANT_INFORMATION_MESSAGE)
            .contains("The hearing will be available to representatives of the media upon request. "
                          + "It will be organised and conducted using MS Teams (unless otherwise stated). "
                          + "Any media representative (or any other member of the public) wishing to witness "
                          + "the hearing will need to do so over the internet and provide an email address at "
                          + "which to be sent an appropriate link for access. Please contact "
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_2).text())
            .as(IMPORTANT_INFORMATION_MESSAGE)
            .contains("Remote hearing via MS Teams. For details on accessing the hearing, "
                          + "please contact admiralty.registrar@justice.gov.uk. "
                          + "Any party who attends the hearing in person at the Rolls Building should contact "
                          + "a member of staff in the List Office who will then connect them to the remote hearings.");
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_3).text())
            .as(IMPORTANT_INFORMATION_MESSAGE)
            .contains("Remote hand-down: This judgment will be handed down remotely by "
                          + "circulation to the parties or their representatives by email "
                          + "and release to The National Archives. A copy of the judgment in "
                          + "final form as handed down should be available on The National "
                          + "Archives website shortly thereafter. Members of the media can "
                          + "obtain a copy on request by email to the Judicial Office "
    ...
    @Test
    void testAdmiraltyCourtKbDailyCauseListFileConversionInWelsh() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
        ...
        softly.assertThat(document.title())
            .as(TITLE_MESSAGE)
            .isEqualTo("Rhestr Achosion Dyddiol Llys y Morlys (Adran Mainc y Brenin)");
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_1).text())
            ...
            .contains("Bydd y gwrandawiad ar gael i gynrychiolwyr y cyfryngau ar "
                          + "gais. Bydd yn cael ei drefnu a'i gynnal gan ddefnyddio "
                          + "MS Teams (oni nodir yn wahanol). Bydd angen i unrhyw gynrychiolydd y "
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_2).text())
            .as(IMPORTANT_INFORMATION_MESSAGE)
            .contains("Gwrandawiad o bell trwy MS Teams. I gael manylion am gael "
                          + "mynediad i'r gwrandawiad, cysylltwch â admiralty.registrar@justice.gov.uk. "
                          + "Dylai unrhyw barti sy'n mynychu'r gwrandawiad wyneb yn wyneb yn "
                          + "yr Adeilad Rolls gysylltu ag aelod o staff yn Swyddfa’r "
                          + "Rhestrau a fydd wedyn yn eu cysylltu â'r gwrandawiadau o bell.");
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_3).text())
            ...
            .contains("Traddodi o Bell: Bydd y dyfarniad hwn yn cael ei draddodi "
                          + "o bell trwy gylchrediad i'r partïon neu eu cynrychiolwyr "
                          + "trwy e-bost a'i ryddhau i'r Archifau Cenedlaethol. "
                          + "Dylai copi o'r dyfarniad ar ffurf derfynol fel y'i "
                          + "rhoddwyd fod ar gael ar wefan yr Archifau Cenedlaethol yn "
                          + "fuan wedyn. Gall aelodau'r cyfryngau gael copi ar gais trwy "
    ...
    @Test
    void testAdmiraltyCourtKbDailyCauseListTableContents() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
            .getResourceAsStream("templates/languages/en/non-strategic/"
