...
@ActiveProfiles("test")
class KingsBenchDivisionDailyCauseListSummaryDataTest extends NonStrategicCommonArtefactSummaryTestConfig {

    @Test
    void testKingsBenchDivisionDailyCauseListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "kingsBenchDivisionDailyCauseList.json", KINGS_BENCH_DIVISION_DAILY_CAUSE_LIST);
