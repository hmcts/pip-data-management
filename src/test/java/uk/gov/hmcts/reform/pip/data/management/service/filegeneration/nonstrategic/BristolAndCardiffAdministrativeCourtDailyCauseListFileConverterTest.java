...
class BristolAndCardiffAdministrativeCourtDailyCauseListFileConverterTest {
    ...
    @Test
    void testBristolAndCardiffAdministrativeCourtDailyCauseListTableContents() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
            .getResourceAsStream("templates/languages/en/non-strategic/"
    ...
    @Test
    void testBristolAndCardiffAdministrativeCourtDailyCauseListExcelConversionInEnglish() throws IOException {
        try (InputStream excelFile = getClass()
            .getResourceAsStream("/mocks/non-strategic/administrativeCourtDailyCauseList.xlsx")) {
            Map<String, String> metadata = Map.of(
                LANGUAGE_METADATA, ENGLISH,
                LIST_TYPE_METADATA, BRISTOL_AND_CARDIFF_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST.name()
            );
    ...
    @Test
    void testBristolAndCardiffAdministrativeCourtDailyCauseListExcelConversionInWelsh() throws IOException {
        try (InputStream excelFile = getClass()
            .getResourceAsStream("/mocks/non-strategic/administrativeCourtDailyCauseList.xlsx")) {
            Map<String, String> metadata = Map.of(
            ...
            byte[] result = converter.convertToExcel(
                null, BRISTOL_AND_CARDIFF_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST, metadata,
                excelFile
            );
