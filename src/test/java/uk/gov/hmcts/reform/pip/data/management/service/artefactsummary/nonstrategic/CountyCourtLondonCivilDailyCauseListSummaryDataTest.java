...
@ActiveProfiles("test")
class CountyCourtLondonCivilDailyCauseListSummaryDataTest extends NonStrategicCommonArtefactSummaryTestConfig {

    @Test
    void testCountyCourtLondonCivilDailyCauseListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "countyCourtLondonCivilDailyCauseList.json", COUNTY_COURT_LONDON_CIVIL_DAILY_CAUSE_LIST);
