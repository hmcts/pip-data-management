...
@ActiveProfiles("test")
class AstDailyHearingListSummaryDataTest extends NonStrategicCommonArtefactSummaryTestConfig {

    @Test
    void testAstDailyListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "astDailyHearingList.json", AST_DAILY_HEARING_LIST);
