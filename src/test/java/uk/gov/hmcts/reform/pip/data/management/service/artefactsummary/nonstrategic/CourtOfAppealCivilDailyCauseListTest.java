...
class CourtOfAppealCivilDailyCauseListTest extends NonStrategicCommonArtefactSummaryTestConfig {

    @Test
    void testCourtOfAppealCivilDailyCauseListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "courtOfAppealCivilDailyCauseList.json", COURT_OF_APPEAL_CIVIL_DAILY_CAUSE_LIST);
