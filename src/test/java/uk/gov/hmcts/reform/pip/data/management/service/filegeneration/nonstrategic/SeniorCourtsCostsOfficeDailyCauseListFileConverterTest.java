...
class SeniorCourtsCostsOfficeDailyCauseListFileConverterTest {
    ...
    @Test
    void testSeniorCourtsCostsOfficeDailyCauseListExcelConversionInEnglish() throws IOException {
        try (InputStream excelFile = getClass()
            .getResourceAsStream("/mocks/non-strategic/seniorCourtsCostsOfficeDailyCauseList.xlsx")) {
            Map<String, String> metadata = Map.of(
                LANGUAGE_METADATA, ENGLISH,
                LIST_TYPE_METADATA, SENIOR_COURTS_COSTS_OFFICE_DAILY_CAUSE_LIST.name()
            );

            byte[] result = converter.convertToExcel(null, SENIOR_COURTS_COSTS_OFFICE_DAILY_CAUSE_LIST, metadata,
                                                     excelFile);
    ...
    @Test
    void testSeniorCourtsCostsOfficeDailyCauseListExcelConversionInWelsh() throws IOException {
        try (InputStream excelFile = getClass()
            .getResourceAsStream("/mocks/non-strategic/seniorCourtsCostsOfficeDailyCauseList.xlsx")) {
            Map<String, String> metadata = Map.of(
                LANGUAGE_METADATA, WELSH,
