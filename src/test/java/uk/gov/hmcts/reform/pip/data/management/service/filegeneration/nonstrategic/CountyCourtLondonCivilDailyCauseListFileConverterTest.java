...
class CountyCourtLondonCivilDailyCauseListFileConverterTest {
    ...
    void setup() throws IOException {
        try (InputStream inputStream = getClass()
            .getResourceAsStream("/mocks/non-strategic/countyCourtLondonCivilDailyCauseList.json")) {
    ...
    @Test
    void testCountyCourtLondonCivilDailyCauseListFileConversionInEnglish() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
            .getResourceAsStream("templates/languages/en/non-strategic/countyCourtLondonCivilDailyCauseList.json")) {
        ...
        Map<String, String> metadata = Map.of(CONTENT_DATE_METADATA, CONTENT_DATE,
                                              ...
                                              LIST_TYPE_METADATA, COUNTY_COURT_LONDON_CIVIL_DAILY_CAUSE_LIST.name(),
        ...
        softly.assertThat(document.title())
            .as(TITLE_MESSAGE)
            .isEqualTo("County Court at Central London Civil Daily Cause List");
    ...
    @Test
    void testCountyCourtLondonCivilDailyCauseListFileConversionInWelsh() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
            .getResourceAsStream("templates/languages/cy/non-strategic/countyCourtLondonCivilDailyCauseList.json")) {
            languageResource = new ObjectMapper().readValue(
                Objects.requireNonNull(languageFile).readAllBytes(), new TypeReference<>() {
                });
        }
        ...
        softly.assertThat(document.title())
            .as(TITLE_MESSAGE)
            .isEqualTo("Rhestr Achosion Dyddiol Sifil yn y Llys Sirol yng Nghanol Llundain");
    ...
    @Test
    void testCountyCourtLondonCivilDailyCauseListTableContents() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
            .getResourceAsStream("templates/languages/en/non-strategic/countyCourtLondonCivilDailyCauseList.json")) {
    ...
    @Test
    void testCountyCourtLondonCivilDailyCauseListExcelConversionInEnglish() throws IOException {
        try (InputStream excelFile = getClass()
            ...
            byte[] result = converter.convertToExcel(null, COUNTY_COURT_LONDON_CIVIL_DAILY_CAUSE_LIST, metadata,
                                                     excelFile);
    ...
    @Test
    void testCountyCourtLondonCivilDailyCauseListExcelConversionInWelsh() throws IOException {
        try (InputStream excelFile = getClass()
            .getResourceAsStream("/mocks/non-strategic/countyCourtLondonCivilDailyCauseList.xlsx")) {
            Map<String, String> metadata = Map.of(
                LANGUAGE_METADATA, WELSH,
