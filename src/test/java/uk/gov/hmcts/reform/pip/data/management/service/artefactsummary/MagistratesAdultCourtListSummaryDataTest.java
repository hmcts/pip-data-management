...
@ActiveProfiles("test")
class MagistratesAdultCourtListSummaryDataTest {
    ...
    void testMagistratesAdultCourtListTemplate(ListType listType) throws IOException {
        StringWriter writer = new StringWriter();
        IOUtils.copy(
            Files.newInputStream(Paths.get(
                "src/test/resources/mocks/",
                "magistratesAdultCourtList.json"
            )), writer,
