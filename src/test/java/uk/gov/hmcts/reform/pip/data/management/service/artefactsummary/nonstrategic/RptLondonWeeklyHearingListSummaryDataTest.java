...
@ActiveProfiles("test")
class RptLondonWeeklyHearingListSummaryDataTest {
    ...
    @Test
    void testRptLondonWeeklyHearingListSummaryData() throws IOException {
        ...
        ArtefactSummaryData cstSummaryData = new ListConversionFactory()
            .getArtefactSummaryData(RPT_LONDON_WEEKLY_HEARING_LIST)
            .get();
