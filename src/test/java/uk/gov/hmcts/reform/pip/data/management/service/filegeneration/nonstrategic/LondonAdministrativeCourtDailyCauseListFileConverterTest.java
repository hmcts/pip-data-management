...
class LondonAdministrativeCourtDailyCauseListFileConverterTest {
    ...
    @Test
    void testLondonAdministrativeCourtDailyCauseListTableContents() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
            .getResourceAsStream("templates/languages/en/non-strategic/londonAdministrativeCourtDailyCauseList.json")) {
    ...
    @Test
    void testLondonAdministrativeCourtDailyCauseListExcelConversionInEnglish() throws IOException {
        try (InputStream excelFile = getClass()
            .getResourceAsStream("/mocks/non-strategic/londonAdministrativeCourtDailyCauseList.xlsx")) {
            Map<String, String> metadata = Map.of(
                LANGUAGE_METADATA, ENGLISH,
                LIST_TYPE_METADATA, LONDON_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST.name()
            );

            byte[] result = converter.convertToExcel(null, LONDON_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST, metadata,
                                                     excelFile);
    ...
    @Test
    void testLondonAdministrativeCourtDailyCauseListExcelConversionInWelsh() throws IOException {
        try (InputStream excelFile = getClass()
            .getResourceAsStream("/mocks/non-strategic/londonAdministrativeCourtDailyCauseList.xlsx")) {
            Map<String, String> metadata = Map.of(
                LANGUAGE_METADATA, WELSH,
