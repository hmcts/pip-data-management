...
class UtIacJudicialReviewLondonDailyHearingListFileConverterTest {
    ...
    @Test
    void testUtIacJudicialReviewDailyHearingListTableContents() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
            .getResourceAsStream("templates/languages/en/non-strategic/utIacJrLondonDailyHearingList.json")) {
    ...
    @Test
    void testUtIacJudicialReviewDailyHearingListExcelConversionInEnglish() throws IOException {
        try (InputStream excelFile = getClass()
            .getResourceAsStream("/mocks/non-strategic/utIacJudicialReviewLondonDailyHearingList.xlsx")) {
            Map<String, String> metadata = Map.of(
                LANGUAGE_METADATA, ENGLISH,
                LIST_TYPE_METADATA, UT_IAC_JR_LONDON_DAILY_HEARING_LIST.name()
            );
    ...
    @Test
    void testUtIacJudicialReviewDailyHearingListExcelConversionInWelsh() throws IOException {
        try (InputStream excelFile = getClass()
            .getResourceAsStream("/mocks/non-strategic/utIacJudicialReviewLondonDailyHearingList.xlsx")) {
            Map<String, String> metadata = Map.of(
                LANGUAGE_METADATA, WELSH,
