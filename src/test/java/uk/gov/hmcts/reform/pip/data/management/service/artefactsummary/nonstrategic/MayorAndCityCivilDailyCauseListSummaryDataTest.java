...
@ActiveProfiles("test")
class MayorAndCityCivilDailyCauseListSummaryDataTest extends NonStrategicCommonArtefactSummaryTestConfig {

    @Test
    void testMayorAndCityCivilDailyCauseListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "mayorAndCityCivilDailyCauseList.json", MAYOR_AND_CITY_CIVIL_DAILY_CAUSE_LIST);
