...
@ActiveProfiles("test")
class RptMidlandsWeeklyHearingListSummaryDataTest {
    ...
    @Test
    void testRptMidlandsWeeklyHearingListSummaryData() throws IOException {
        ...
        ArtefactSummaryData cstSummaryData = new ListConversionFactory()
            .getArtefactSummaryData(RPT_MIDLANDS_WEEKLY_HEARING_LIST)
            .get();
