...
class PensionsListChdDailyCauseListSummaryDataTest extends NonStrategicCommonArtefactSummaryTestConfig {

    @Test
    void testPensionsListChdDailyCauseListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "pensionsListChdDailyCauseList.json", PENSIONS_LIST_CHD_DAILY_CAUSE_LIST);
