...
@ActiveProfiles("test")
class InterimApplicationsChdDailyCauseListSummaryDataTest {
    ...
    @Test
    void testInterimApplicationsDailyListSummaryData() throws IOException {
        ...
        ArtefactSummaryData cstSummaryData = new ListConversionFactory()
            .getArtefactSummaryData(INTERIM_APPLICATIONS_CHD_DAILY_CAUSE_LIST)
            .get();
