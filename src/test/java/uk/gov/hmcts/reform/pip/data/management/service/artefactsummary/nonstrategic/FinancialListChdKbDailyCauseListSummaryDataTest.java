...
class FinancialListChdKbDailyCauseListSummaryDataTest extends NonStrategicCommonArtefactSummaryTestConfig {

    @Test
    void testFinancialListChdKbDailyCauseListSummaryData() throws IOException {
        Map<String, List<Map<String, String>>> output = getArtefactSummaryOutput(
            "financialListChdKbDailyCauseList.json", FINANCIAL_LIST_CHD_KB_DAILY_CAUSE_LIST);
