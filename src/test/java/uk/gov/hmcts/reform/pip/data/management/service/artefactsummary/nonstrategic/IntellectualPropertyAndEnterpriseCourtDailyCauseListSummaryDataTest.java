...
class IntellectualPropertyAndEnterpriseCourtDailyCauseListSummaryDataTest {
    ...
    @Test
    void testIntellectualPropertyAndEnterpriseCourtDailyCauseListSummaryData() throws IOException {
        ...
        ArtefactSummaryData cstSummaryData = new ListConversionFactory()
            .getArtefactSummaryData(INTELLECTUAL_PROPERTY_AND_ENTERPRISE_COURT_DAILY_CAUSE_LIST)
            .get();
