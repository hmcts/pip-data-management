...
class CrownDailyPddaListFileConverterTest {
    ...
    CrownDailyPddaListFileConverter crownDailyPddaListConverter = new CrownDailyPddaListFileConverter();
    ...
    void testCrownDailyListExcelConversion() throws IOException {
        ...
        softly.assertThat(sheet.getSheetName())
            ...
            .isEqualTo(CROWN_DAILY_PDDA_LIST.getFriendlyName());
