...
class CommercialCourtKbDailyCauseListFileConverterTest {
    ...
    void setup() throws IOException {
        try (InputStream inputStream = getClass()
            .getResourceAsStream("/mocks/non-strategic/commercialCourtKbDailyCauseList.json")) {
    ...
    @Test
    void testCommercialCourtKbDailyCauseListFileConversionInEnglish() throws IOException {
        ...
        Map<String, String> metadata = Map.of(CONTENT_DATE_METADATA, CONTENT_DATE,
                                              ...
                                              COMMERCIAL_COURT_KB_DAILY_CAUSE_LIST.name(),
        ...
        softly.assertThat(document.title())
            .as(TITLE_MESSAGE)
            .isEqualTo("Commercial Court (King’s Bench Division) Daily Cause List");
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_1).text())
            ...
            .contains("The hearing will be available to representatives of the media upon request. "
                          ...
                          + "Any media representative (or any other member of the public) wishing to "
                          + "witness the hearing will need to do so over the internet and provide an "
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_2).text())
            .as(IMPORTANT_INFORMATION_MESSAGE)
            .contains("Remote hand-down: This judgment will be handed down remotely "
                          + "by circulation to the parties or their representatives "
                          + "by email and release to The National Archives. A copy of the "
    ...
    @Test
    void testCommercialCourtKbDailyCauseListFileConversionInWelsh() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
        ...
        softly.assertThat(document.title())
            .as(TITLE_MESSAGE)
            .isEqualTo("Rhestr Achosion Dyddiol y Llys Masnach (Adran Mainc y Brenin)");
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_1).text())
            .as(IMPORTANT_INFORMATION_MESSAGE)
            .contains("Bydd y gwrandawiad ar gael i gynrychiolwyr y cyfryngau ar gais. "
                          + "Bydd yn cael ei drefnu a'i gynnal gan ddefnyddio MS Teams (oni nodir yn wahanol). "
                          + "Bydd angen i unrhyw gynrychiolydd y cyfryngau (neu unrhyw aelod arall o'r cyhoedd) "
                          + "sy'n dymuno gweld y gwrandawiad wneud hynny dros y rhyngrwyd a darparu cyfeiriad "
                          + "e-bost i gael dolen briodol ar gyfer cael mynediad. Cysylltwch â "
        ...
        softly.assertThat(document.getElementById(IMPORTANT_INFORMATION_ELEMENT_2).text())
            ...
            .contains("Traddodi o Bell: Bydd y dyfarniad hwn yn cael ei draddodi o "
                          + "bell trwy gylchrediad i'r partïon neu eu cynrychiolwyr trwy "
    ...
    @Test
    void testCommercialCourtKbDailyCauseListTableContents() throws IOException {
        Map<String, Object> languageResource;
        try (InputStream languageFile = Thread.currentThread()
            .getContextClassLoader()
            .getResourceAsStream("templates/languages/en/non-strategic/"
