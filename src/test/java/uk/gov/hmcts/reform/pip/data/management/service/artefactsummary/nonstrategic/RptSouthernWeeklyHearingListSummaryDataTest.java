...
@ActiveProfiles("test")
class RptSouthernWeeklyHearingListSummaryDataTest {
    ...
    @Test
    void testRptSouthernWeeklyHearingListSummaryData() throws IOException {
        ...
        ArtefactSummaryData cstSummaryData = new ListConversionFactory()
            .getArtefactSummaryData(RPT_EASTERN_WEEKLY_HEARING_LIST)
            .get();
