...
public class ListConversionFactory {
    ...
    private static final Map<ListType, ConversionConfig> LIST_MAP = Map.ofEntries(
        Map.entry(SJP_PUBLIC_LIST, new ConversionConfig(new SjpPublicListFileConverter())),
        Map.entry(SJP_DELTA_PUBLIC_LIST, new ConversionConfig(new SjpPublicListFileConverter())),
        ...
        Map.entry(SSCS_DAILY_LIST, new ConversionConfig(new SscsDailyListFileConverter(),
                                                        new SscsDailyListSummaryData())),
        Map.entry(SSCS_DAILY_LIST_ADDITIONAL_HEARINGS, new ConversionConfig(new SscsDailyListFileConverter(),
                                                                            new SscsDailyListSummaryData())),
        Map.entry(IAC_DAILY_LIST, new ConversionConfig(new IacDailyListFileConverter(),
                                                       new IacDailyListSummaryData())),
        Map.entry(IAC_DAILY_LIST_ADDITIONAL_CASES, new ConversionConfig(new IacDailyListFileConverter(),
                                                                        new IacDailyListSummaryData())),
        Map.entry(ET_DAILY_LIST, new ConversionConfig(new EtDailyListFileConverter(),
                                                      new EtDailyListSummaryData())),
        Map.entry(ET_FORTNIGHTLY_PRESS_LIST, new ConversionConfig(new EtFortnightlyPressListFileConverter(),
                                                                  new EtFortnightlyPressListSummaryData())),
        Map.entry(CST_WEEKLY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(), new NonStrategicListSummaryData(CST_WEEKLY_HEARING_LIST)
        )),
        Map.entry(PHT_WEEKLY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(), new NonStrategicListSummaryData(PHT_WEEKLY_HEARING_LIST)
        )),
        Map.entry(GRC_WEEKLY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(), new NonStrategicListSummaryData(GRC_WEEKLY_HEARING_LIST)
        )),
        Map.entry(WPAFCC_WEEKLY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(), new NonStrategicListSummaryData(WPAFCC_WEEKLY_HEARING_LIST)
        )),
        Map.entry(UT_IAC_JR_LONDON_DAILY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(UT_IAC_JR_LONDON_DAILY_HEARING_LIST)
        )),
        Map.entry(UT_IAC_JR_MANCHESTER_DAILY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(UT_IAC_JR_MANCHESTER_DAILY_HEARING_LIST)
        )),
        Map.entry(UT_IAC_JR_BIRMINGHAM_DAILY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(UT_IAC_JR_BIRMINGHAM_DAILY_HEARING_LIST)
        )),
        Map.entry(UT_IAC_JR_CARDIFF_DAILY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(UT_IAC_JR_CARDIFF_DAILY_HEARING_LIST)
        )),
        Map.entry(UT_IAC_JR_LEEDS_DAILY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(UT_IAC_JR_LEEDS_DAILY_HEARING_LIST)
        )),
        Map.entry(UT_IAC_STATUTORY_APPEALS_DAILY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(UT_IAC_STATUTORY_APPEALS_DAILY_HEARING_LIST)
        )),
        Map.entry(SIAC_WEEKLY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(SIAC_WEEKLY_HEARING_LIST)
        )),
        Map.entry(POAC_WEEKLY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(POAC_WEEKLY_HEARING_LIST)
        )),
        Map.entry(PAAC_WEEKLY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(PAAC_WEEKLY_HEARING_LIST)
        )),
        Map.entry(FTT_TAX_WEEKLY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(FTT_TAX_WEEKLY_HEARING_LIST)
        )),
        Map.entry(FTT_LR_WEEKLY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(FTT_LR_WEEKLY_HEARING_LIST)
        )),
        Map.entry(RPT_EASTERN_WEEKLY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(RPT_EASTERN_WEEKLY_HEARING_LIST)
        )),
        Map.entry(RPT_LONDON_WEEKLY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(RPT_LONDON_WEEKLY_HEARING_LIST)
        )),
        Map.entry(RPT_MIDLANDS_WEEKLY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(RPT_MIDLANDS_WEEKLY_HEARING_LIST)
        )),
        Map.entry(RPT_NORTHERN_WEEKLY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(RPT_NORTHERN_WEEKLY_HEARING_LIST)
        )),
        Map.entry(RPT_SOUTHERN_WEEKLY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(RPT_SOUTHERN_WEEKLY_HEARING_LIST)
        )),
        Map.entry(UT_T_AND_CC_DAILY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(UT_T_AND_CC_DAILY_HEARING_LIST)
        )),
        Map.entry(UT_LC_DAILY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(UT_LC_DAILY_HEARING_LIST)
        )),
        Map.entry(UT_AAC_DAILY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(UT_AAC_DAILY_HEARING_LIST)
        )),
        Map.entry(AST_DAILY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(), new NonStrategicListSummaryData(AST_DAILY_HEARING_LIST)
        )),
        Map.entry(SSCS_MIDLANDS_DAILY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(SSCS_MIDLANDS_DAILY_HEARING_LIST)
        )),
        Map.entry(SSCS_SOUTH_EAST_DAILY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(SSCS_SOUTH_EAST_DAILY_HEARING_LIST)
        )),
        Map.entry(SSCS_WALES_AND_SOUTH_WEST_DAILY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(SSCS_WALES_AND_SOUTH_WEST_DAILY_HEARING_LIST)
        )),
        Map.entry(SSCS_SCOTLAND_DAILY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(SSCS_SCOTLAND_DAILY_HEARING_LIST)
        )),
        Map.entry(SSCS_NORTH_EAST_DAILY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(SSCS_NORTH_EAST_DAILY_HEARING_LIST)
        )),
        Map.entry(SSCS_NORTH_WEST_DAILY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(SSCS_NORTH_WEST_DAILY_HEARING_LIST)
        )),
        Map.entry(SSCS_LONDON_DAILY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(SSCS_LONDON_DAILY_HEARING_LIST)
        )),
        Map.entry(LONDON_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(LONDON_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST)
        )),
        Map.entry(COUNTY_COURT_LONDON_CIVIL_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(COUNTY_COURT_LONDON_CIVIL_DAILY_CAUSE_LIST)
        )),
        Map.entry(CIVIL_COURTS_RCJ_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(CIVIL_COURTS_RCJ_DAILY_CAUSE_LIST)
        )),
        Map.entry(COURT_OF_APPEAL_CRIMINAL_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(COURT_OF_APPEAL_CRIMINAL_DAILY_CAUSE_LIST)
        )),
        Map.entry(FAMILY_DIVISION_HIGH_COURT_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(FAMILY_DIVISION_HIGH_COURT_DAILY_CAUSE_LIST)
        )),
        Map.entry(KINGS_BENCH_DIVISION_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(KINGS_BENCH_DIVISION_DAILY_CAUSE_LIST)
        )),
        Map.entry(KINGS_BENCH_MASTERS_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(KINGS_BENCH_MASTERS_DAILY_CAUSE_LIST)
        )),
        Map.entry(SENIOR_COURTS_COSTS_OFFICE_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(SENIOR_COURTS_COSTS_OFFICE_DAILY_CAUSE_LIST)
        )),
        Map.entry(MAYOR_AND_CITY_CIVIL_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(MAYOR_AND_CITY_CIVIL_DAILY_CAUSE_LIST)
        )),
        Map.entry(INTERIM_APPLICATIONS_CHD_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
        ...
        Map.entry(INTELLECTUAL_PROPERTY_AND_ENTERPRISE_COURT_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(INTELLECTUAL_PROPERTY_AND_ENTERPRISE_COURT_DAILY_CAUSE_LIST)
        )),
        Map.entry(INTELLECTUAL_PROPERTY_LIST_CHD_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(INTELLECTUAL_PROPERTY_LIST_CHD_DAILY_CAUSE_LIST)
        )),
        Map.entry(LONDON_CIRCUIT_COMMERCIAL_COURT_KB_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(LONDON_CIRCUIT_COMMERCIAL_COURT_KB_DAILY_CAUSE_LIST)
        )),
        Map.entry(PATENTS_COURT_CHD_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(PATENTS_COURT_CHD_DAILY_CAUSE_LIST)
        )),
        Map.entry(PENSIONS_LIST_CHD_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(PENSIONS_LIST_CHD_DAILY_CAUSE_LIST)
        )),
        Map.entry(PROPERTY_TRUSTS_PROBATE_LIST_CHD_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(PROPERTY_TRUSTS_PROBATE_LIST_CHD_DAILY_CAUSE_LIST)
        )),
        Map.entry(REVENUE_LIST_CHD_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(REVENUE_LIST_CHD_DAILY_CAUSE_LIST)
        )),
        Map.entry(TECHNOLOGY_AND_CONSTRUCTION_COURT_KB_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(TECHNOLOGY_AND_CONSTRUCTION_COURT_KB_DAILY_CAUSE_LIST)
        )),
        Map.entry(ADMIRALTY_COURT_KB_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(ADMIRALTY_COURT_KB_DAILY_CAUSE_LIST)
        )),
        Map.entry(BUSINESS_LIST_CHD_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(BUSINESS_LIST_CHD_DAILY_CAUSE_LIST)
        )),
        Map.entry(CHANCERY_APPEALS_CHD_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(CHANCERY_APPEALS_CHD_DAILY_CAUSE_LIST)
        )),
        Map.entry(COMMERCIAL_COURT_KB_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(COMMERCIAL_COURT_KB_DAILY_CAUSE_LIST)
        )),
        Map.entry(COMPANIES_WINDING_UP_CHD_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(COMPANIES_WINDING_UP_CHD_DAILY_CAUSE_LIST)
        )),
        Map.entry(COMPETITION_LIST_CHD_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(COMPETITION_LIST_CHD_DAILY_CAUSE_LIST)
        )),
        Map.entry(FINANCIAL_LIST_CHD_KB_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(FINANCIAL_LIST_CHD_KB_DAILY_CAUSE_LIST)
        )),
        Map.entry(INSOLVENCY_AND_COMPANIES_COURT_CHD_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(INSOLVENCY_AND_COMPANIES_COURT_CHD_DAILY_CAUSE_LIST)
        )),
        Map.entry(BIRMINGHAM_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(BIRMINGHAM_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST)
        )),
        Map.entry(BRISTOL_AND_CARDIFF_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(BRISTOL_AND_CARDIFF_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST)
        )),
        Map.entry(MANCHESTER_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(MANCHESTER_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST)
        )),
        Map.entry(LEEDS_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(LEEDS_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST)
        )),
        Map.entry(SEND_DAILY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
            new NonStrategicListSummaryData(SEND_DAILY_HEARING_LIST)
        )),
        Map.entry(CIC_WEEKLY_HEARING_LIST, new ConversionConfig(
            new NonStrategicListFileConverter(),
