...
class PublicationOpaPublicListTest {
    ...
    @Test
    void testCreationOfValidOpaPublicList() throws Exception {
        try (InputStream mockFile = this.getClass().getClassLoader()
            .getResourceAsStream("data/opa-public-list/opaPublicList.json")) {
            ...
            MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders
                ...
                .header(PublicationConfiguration.LIST_TYPE, ListType.OPA_PUBLIC_LIST)
