...
import static uk.gov.hmcts.reform.pip.data.management.controllers.tests.helpers.ArtefactConstantTestHelper.ARTEFACT_ID;
import static uk.gov.hmcts.reform.pip.data.management.controllers.tests.helpers.ArtefactConstantTestHelper.CONTENT_DATE;
import static uk.gov.hmcts.reform.pip.data.management.controllers.tests.helpers.ArtefactConstantTestHelper.LOCATION_ID;
import static uk.gov.hmcts.reform.pip.data.management.controllers.tests.helpers.ArtefactConstantTestHelper.LOCATION_VENUE;
import static uk.gov.hmcts.reform.pip.data.management.controllers.tests.helpers.ArtefactConstantTestHelper.PAYLOAD_URL;
import static uk.gov.hmcts.reform.pip.data.management.controllers.tests.helpers.ArtefactConstantTestHelper.PROVENANCE;
import static uk.gov.hmcts.reform.pip.data.management.controllers.tests.helpers.ArtefactConstantTestHelper.PROVENANCE_ID;
import static uk.gov.hmcts.reform.pip.data.management.controllers.tests.helpers.ArtefactConstantTestHelper.SEARCH_TERM_CASE_ID;
import static uk.gov.hmcts.reform.pip.data.management.controllers.tests.helpers.ArtefactConstantTestHelper.SEARCH_TERM_CASE_NAME;
import static uk.gov.hmcts.reform.pip.data.management.controllers.tests.helpers.ArtefactConstantTestHelper.SEARCH_TERM_CASE_URN;
import static uk.gov.hmcts.reform.pip.data.management.controllers.tests.helpers.ArtefactConstantTestHelper.SEARCH_VALUES;
import static uk.gov.hmcts.reform.pip.data.management.controllers.tests.helpers.ArtefactConstantTestHelper.SOURCE_ARTEFACT_ID;
import static uk.gov.hmcts.reform.pip.data.management.controllers.tests.helpers.ArtefactConstantTestHelper.TEST_KEY;
import static uk.gov.hmcts.reform.pip.data.management.controllers.tests.helpers.ArtefactConstantTestHelper.TEST_VALUE;
import static uk.gov.hmcts.reform.pip.data.management.controllers.tests.helpers.ArtefactConstantTestHelper.USER_ID;
import static uk.gov.hmcts.reform.pip.data.management.controllers.tests.helpers.ArtefactConstantTestHelper.VALIDATION_ARTEFACT_NOT_MATCH;
import static uk.gov.hmcts.reform.pip.data.management.controllers.tests.helpers.ArtefactConstantTestHelper.VALIDATION_MORE_THAN_PUBLIC;
