...
class PublicationCivilAndFamilyCauseListTest {
    ...
    @Test
    void testCreationOfValidCivilAndFamilyDailyCauseList() throws Exception {
        try (InputStream mockFile = this.getClass().getClassLoader()
            .getResourceAsStream("data/civil-and-family-cause-list/civilAndFamilyDailyCauseList.json")) {
            ...
            MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders
                ...
                .header(PublicationConfiguration.LIST_TYPE, ListType.CIVIL_AND_FAMILY_DAILY_CAUSE_LIST)
    ...
    @Test
    void testCreationOfInvalidCivilAndFamilyDailyCauseListList() throws Exception {
        try (InputStream mockFile = this.getClass().getClassLoader()
            .getResourceAsStream("data/civil-and-family-cause-list/civilAndFamilyDailyCauseListInvalid.json")) {
