...
class PublicationCrownWarnedListTest {
    ...
    @Test
    void testCreationOfValidCrownWarnedList() throws Exception {
        try (InputStream mockFile = this.getClass().getClassLoader()
            .getResourceAsStream("data/crown-warned-list/crownWarnedList.json")) {
            ...
            MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders
                ...
                .header(PublicationConfiguration.LIST_TYPE, ListType.CROWN_WARNED_LIST)
    ...
    @Test
    void testCreationOfInvalidCrownWarnedList() throws Exception {
        try (InputStream mockFile = this.getClass().getClassLoader()
            .getResourceAsStream("data/crown-warned-list/crownWarnedListInvalid.json")) {
