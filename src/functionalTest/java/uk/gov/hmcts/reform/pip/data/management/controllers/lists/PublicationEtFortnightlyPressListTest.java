...
class PublicationEtFortnightlyPressListTest {
    ...
    @Test
    void testCreationOfValidEtFortnightlyPressList() throws Exception {
        try (InputStream mockFile = this.getClass().getClassLoader()
            .getResourceAsStream("data/et-fortnightly-press-list/etFortnightlyPressList.json")) {
            ...
            MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders
                ...
                .header(PublicationConfiguration.LIST_TYPE, ListType.ET_FORTNIGHTLY_PRESS_LIST)
    ...
    @Test
    void testCreationOfInvalidEtFortnightlyPressList() throws Exception {
        try (InputStream mockFile = this.getClass().getClassLoader()
            .getResourceAsStream("data/et-fortnightly-press-list/etFortnightlyPressListInvalid.json")) {
