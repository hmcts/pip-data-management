...
class PublicationCareStandardsListTest {
    ...
    @Test
    void testCreationOfValidCareStandardsList() throws Exception {
        try (InputStream mockFile = this.getClass().getClassLoader()
            ...
            MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders
                ...
                .header(PublicationConfiguration.LIST_TYPE, ListType.CARE_STANDARDS_LIST)
