...
class PublicationMagistratesStandardListTest {
    ...
    void testCreationOfValidMagistratesStandardList() throws Exception {
        try (InputStream mockFile = this.getClass().getClassLoader()
            .getResourceAsStream("data/magistrates-standard-list/magistratesStandardList.json")) {
            ...
            MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders
                ...
                .header(PublicationConfiguration.LIST_TYPE, ListType.MAGISTRATES_STANDARD_LIST)
    ...
    void testCreationOfInvalidMagistratesStandardList() throws Exception {
        try (InputStream mockFile = this.getClass().getClassLoader()
            .getResourceAsStream("data/magistrates-standard-list/magistrateStandardList.json")) {
