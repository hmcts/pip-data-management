...
class PublicationPrimaryHealthListTest {
    ...
    @Test
    void testCreationOfValidPrimaryHealthList() throws Exception {
        try (InputStream mockFile = this.getClass().getClassLoader()
            .getResourceAsStream("data/primary-health-list/primaryHealthList.json")) {
            ...
            MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders
                ...
                .header(PublicationConfiguration.LIST_TYPE, ListType.PRIMARY_HEALTH_LIST)
    ...
    @Test
    void testCreationOfInvalidPrimaryHealthList() throws Exception {
        try (InputStream mockFile = this.getClass().getClassLoader()
            .getResourceAsStream("data/primary-health-list/primaryHealthListInvalid.json")) {
