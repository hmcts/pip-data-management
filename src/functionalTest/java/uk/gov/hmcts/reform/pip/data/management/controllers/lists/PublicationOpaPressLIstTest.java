...
class PublicationOpaPressLIstTest {
    ...
    @Test
    void testCreationOfValidOpaPressList() throws Exception {
        try (InputStream mockFile = this.getClass().getClassLoader()
            .getResourceAsStream("data/opa-press-list/opaPressList.json")) {
            ...
            MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders
                ...
                .header(PublicationConfiguration.LIST_TYPE, ListType.OPA_PRESS_LIST)
    ...
    @Test
    void testCreationOfInvalidOpaPressList() throws Exception {
        try (InputStream mockFile = this.getClass().getClassLoader()
            .getResourceAsStream("data/opa-press-list/opaPressListInvalid.json")) {
            ...
            assertTrue(
                exceptionResponse.getMessage().contains("caseUrn"),
                "caseUrn is not displayed in the exception response"
            );
        }
    }
}
