...
class PublicationSscsDailyListTest {
    ...
    void testCreationOfValidSscsDailyList(ListType listType) throws Exception {
    ...
    @ParameterizedTest
    @EnumSource(value = ListType.class, names = {"SSCS_DAILY_LIST", "SSCS_DAILY_LIST_ADDITIONAL_HEARINGS"})
    void testCreationOfInvalidSscsDailyList(ListType listType) throws Exception {
        try (InputStream mockFile = this.getClass().getClassLoader()
            .getResourceAsStream("data/sscs-daily-list/sscsDailyListInvalid.json")) {
